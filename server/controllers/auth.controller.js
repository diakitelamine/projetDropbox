...
const { GOOGLE_CLIENT, JWT_SECRET, JWT_ACCOUNT_ACTIVATION, JWT_RESET_PASSWORD, EMAIL_FROM, CLIENT_URL, MAIL_KEY } = require('../config/config');
        ...
        User.findOne({
            ...
            (err, user) => {
                ...
                const emailData = {
                    ...
                    <p>${CLIENT_URL}/users/password/reset/${token}</p>
                    <hr />
...
exports.resetPasswordController = (req, res) => {
    ...
    if (!errors.isEmpty()) {
        ...
        if (resetPasswordLink) {
            jwt.verify(resetPasswordLink, JWT_RESET_PASSWORD, function(
                err,
                decoded
            ) {
                if (err) {
